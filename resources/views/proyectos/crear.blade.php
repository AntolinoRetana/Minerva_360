...
@section('content')
    ...
    <div class="page-header d-flex justify-content-between align-items-center mb-4">
        <h1 class="fw-bold h2-institucional mb-0">Crear Nuevo Proyecto</h1>
        <div>
    ...
    <div class="card shadow-sm border-0 rounded-3">
        <!-- El padding se lo daremos al card-body para más control -->
        <div class="card-body p-4 p-md-5">
            
            <!-- Título dentro de la tarjeta -->
            <h5 class="card-title fw-bold mb-4">Detalles del Proyecto</h5>

            <!-- Aquí se renderizará tu formulario de Livewire -->
            <livewire:proyecto-create />
        </div>
    </div>
